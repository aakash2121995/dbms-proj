		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container-fluid ">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">JMI Cart</a>
				</div>
				...
				<div id="my-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="item active">
							...
							<img alt="First slide" src="Img/main-slider-1.jpg" />
						...
						<div class="item">
							<img alt="First slide" src="Img/main-slider-2.jpg" />
							<div class="carousel-caption">
						...
						<div class="item">
							<img alt="First slide" src="Img/main-slider-3.jpg" />
							<div class="carousel-caption">
						...
						<div class="item">
							<img alt="First slide" src="Img/main-slider-4.jpg" />
							<div class="carousel-caption">
								<h3>Caption heading 3</h3>
								<p>Suspendisse ullamcorper massa eget eleifend iaculis.</p>
							</div>
						...
						<div class="item">
							<img alt="First slide" src="Img/main-slider-5.jpg" />
							<div class="carousel-caption">
								<h3>Caption heading 3</h3>
								<p>Suspendisse ullamcorper massa eget eleifend iaculis.</p>
							</div>
						...
						<div class="item">
							<img alt="First slide" src="Img/main-slider-6.jpg" />
							<div class="carousel-caption">
								<h3>Caption heading 3</h3>
								<p>Suspendisse ullamcorper massa eget eleifend iaculis.</p>
							</div>
